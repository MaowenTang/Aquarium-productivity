        ...
        <>
          ...
          <motion.div
            ...
            className="fixed 
                       ...
                       w-full md:w-[500px] md:max-w-[90vw]
          ...
          >
              ...
              <div className="p-6 pb-4 space-y-5">
                ...
                <div className="space-y-3 pr-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h2 className="text-2xl font-bold text-blue-900 dark:text-blue-100 leading-tight break-words">
                        {task.title}
                      </h2>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <Badge 
                      variant="outline" 
                      className={`${getPriorityColor(task.priority)} border-2 px-3 py-1.5 font-medium`}
                    >
                ...
                <div className="space-y-3">
                  ...
                  {task.deadline && (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-0.5">Due Time</p>
                  ...
                  {urgency.timeUntilDue !== null && (
                    <motion.div
                      ...
                      className={`flex items-center gap-3 p-4 rounded-xl backdrop-blur-sm border-2
                ...
                {task.description && task.description.trim() && (
                  <motion.div
                    ...
                    className="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-purple-50/80 to-pink-50/80 
                               dark:from-purple-900/20 dark:to-pink-900/20
                               border-2 border-purple-200/50 dark:border-purple-700/50 backdrop-blur-sm"
                  >
                    ...
                    <div className="flex-1 min-w-0 max-h-32 overflow-y-auto">
                      <p className="text-xs text-purple-600 dark:text-purple-400 font-medium mb-1">Description</p>
                      <p className="text-sm text-purple-900 dark:text-purple-100 leading-relaxed whitespace-pre-wrap break-words">
                        {task.description}
                      </p>
                    </div>
                  </motion.div>
            ...
            <div className="border-t-2 border-blue-200/30 dark:border-blue-700/30 bg-blue-50/50 dark:bg-slate-800/50 backdrop-blur-sm p-6">
              <motion.div
              ...
              >
                ...
                <Button
                  ...
                  className="w-full h-12 border-2 border-blue-300 dark:border-blue-700
                             text-blue-700 dark:text-blue-300 font-medium rounded-xl text-base
