...
export function WeatherDisplay({ onActivitySelect, showRecommendations = true }: WeatherDisplayProps) {
  ...
  return (
    ...
    >
      {/* Main Weather Card */}
      <Card className={`glass-morandi float-3d overflow-hidden bg-gradient-to-br ${theme.backgroundClass}`}>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg">Ocean Weather</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <motion.p 
                  className={`text-3xl font-medium ${theme.accentColor}`}
              ...
              <div className="space-y-3">
                <AnimatePresence>
                  {recommendations.map((rec, index) => (
                    ...
                    >
                      <motion.div
                        className="p-3 rounded-2xl glass-morandi border border-white/20 cursor-pointer"
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <p className="font-medium text-blue-800 text-sm">{rec.activity}</p>
                            <p className="text-xs text-blue-600/80">{rec.description}</p>
                          </div>
                          <motion.div
